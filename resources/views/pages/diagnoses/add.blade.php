    ...
    <nav class="my-4"
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="/patients" class="text-decoration-none">Patient Records</a>
            </li>
            <li class="breadcrumb-item">
                <a href="/patient/{{ $patient['id'] }}" class="text-decoration-none">{{ $patient['name'] }}</a>
            </li>
            <li class="breadcrumb-item" aria-current="page">Add Medical Record</li>
        </ol>
    </nav>
